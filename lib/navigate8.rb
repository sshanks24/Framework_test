...
module Nav
  ...
  def s_name; $ie.frame(:index, 3).frame(:index, 3).table(:index, 2)[2][2]; end
  # - Equipment Contact in Support page table
  def s_cont; $ie.frame(:index, 3).frame(:index, 3).table(:index, 2)[5][2]; end
  # - Equipment Location in Support page table
  def s_loc; $ie.frame(:index, 3).frame(:index, 3).table(:index, 2)[3][2]; end
  # - Equipment Description in Support page table
  def s_desc; $ie.frame(:index, 3).frame(:index, 3).table(:index, 2)[4][2]; end
...
#define customize message functions
  ...
  # - Restart button
  def restart1; det.button(:name, 'Submit'); end
